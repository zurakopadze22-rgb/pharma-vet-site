...
const Hero = ({ t, lang, setView }) => {
  const seoInfo = {
    GE: {
      title: "Pharma Vet • ვეტერინარული პრეპარატები, პერორალური ხსნარი",
      description: "Pharma Vet Georgia - ვეტერინარული პრეპარატების იმპორტი, დისტრიბუცია, პერორალური ხსნარი, წამლები, ოფიციალური პარტნიორები და რჩევები ცხოველთა მოვლაზე.",
      keywords: "Pharma Vet, ვეტერინარული პრეპარატები, პერორალური ხსნარი, წამლები, ოფიციალური პარტნიორები, ხსნარი პერორალური მიღებისთვის, ცხოველების წამლები, რჩევები ცხოველებზე, ვეტერინარული ბლოგი, ძაღლის კვება, კატის ვიტამინები, ვეტერინარია საქართველო, ფარმავეტი, ფუტკრის მოვლა, მეცხოველეობა, pharmavet.ge"
    },
    EN: {
      title: "Pharma Vet • Veterinary Pharmaceuticals & Oral Solution",
      description: "Pharma Vet Georgia - Import and distribution of high-quality veterinary pharmaceuticals, oral solutions, medicines, and official partners.",
    ...
    RU: {
      title: "Pharma Vet • Ветеринарные препараты, оральный раствор",
      description: "Pharma Vet Georgia - Импорт и дистрибуция ветеринарных препаратов, оральные растворы, лекарства и официальные партнеры.",
